...
//编码[字母、数字、点、下划线、横线]
jQuery.validator.addMethod("isCode",
function(value, element) {
...
// 中文或英文验证
jQuery.validator.addMethod("en_zh",
function(value, element) {
    return this.optional(element) || /^[a-zA-Z\u4e00-\u9fa5]+$/.test(value);
},
"只能包括中文、英文、空格");
// 中文或英文或空格验证
jQuery.validator.addMethod("en_zh_space",
function(value, element) {
    return this.optional(element) || /^[a-zA-Z\u4e00-\u9fa5\s]+$/.test(value);
},
"只能包括中文、英文、空格");
// 中文或英文验证
jQuery.validator.addMethod("en_zh_num",
function(value, element) {
    return this.optional(element) || /^[a-zA-Z0-9\u4e00-\u9fa5]+$/.test(value);
},
"只能包括中文、英文或数字");
// 中文或英文验证
jQuery.validator.addMethod("en_zh_num_s",
function(value, element) {
...
"只能包括中文字、英文字母、数字和下划线");
// 字符验证
jQuery.validator.addMethod("eng_num",
function(value, element) {
    return this.optional(element) || /^[A-Za-z0-9]+$/.test(value);
},
"只能为英文字母或数字");
// 英文验证
jQuery.validator.addMethod("english",
function(value, element) {
...
// 电话号码-手机号码验证
jQuery.validator.addMethod("mobile_phone",
function(value, element) {
    var length = value.length;
...
function addRules(validator, rule) {
    ...
    var empty = {}
    var messages = $.extend(empty, validator.settings.messages, rule.getMessages());
